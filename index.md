...
- [DiffusionDB](#diffusiondb)
  ...
  - [Dataset Structure](#dataset-structure)
    ...
    - [Loading Data Subsets](#loading-data-subsets)
      ...
      - [Method 2. Use the anonacl Downloader](#method-2-use-the-anonacl-downloader)
...
- **Homepage:** [DiffusionDB homepage](https://anonacl.github.io/diffusiondb)
- **Repository:** [DiffusionDB repository](https://github.com/anonacl/diffusiondb)
- **Distribution:** [DiffusionDB Dataset](https://anonymous.link)
- **Point of Contact:** Anonymous Authors
...
DiffusionDB is publicly available at Anonymous Link.
...
You can use the Hugging Face [`Datasets`](https://huggingface.co/docs/datasets/quickstart) library to easily load prompts and images from DiffusionDB. We pre-defined 16 DiffusionDB subsets (configurations) based on the number of instances. You can see all subsets in the [Dataset Preview](https://huggingface.co/datasets/anonacl/diffusiondb/viewer/all/train).
...
#### Method 2. Use the anonacl Downloader
...
table_url = f'https://huggingface.co/datasets/anonacl/diffusiondb/resolve/main/metadata.parquet'
...
The Python code in this repository is available under the [MIT License](https://github.com/anonacl/diffusiondb/blob/main/LICENSE).
