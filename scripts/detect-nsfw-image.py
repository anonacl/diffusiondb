...
ZIP_DIR_2M = "/project/diffusiondb-hugging/images/"
WORK_DIR = "/nvmescratch/diffusiondb"

if LARGE_MODE:
    NSFW_SCORE_DIR = "/nvmescratch/diffusiondb/nsfw-scores-large"
else:
    NSFW_SCORE_DIR = "/nvmescratch/diffusiondb/nsfw-scores-2m"
